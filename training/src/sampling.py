...
def reverse_sample(
    ...
    for t, s in zip(timesteps, boundary_timesteps):
        with torch.autocast("cuda", dtype=torch.float16):
            ...
            noise_pred = pipe.unet(
                ...
                return_dict=False,
                timestep_cond=w_embedding if t != 999 else w_zero_embedding,
    ...
    print('AFTER SAMPLING: ', image.min().item(), image.max().item())
